        ...
        try:
            ...
            if (
                ...
                if mask.any():
                    ...
                    main_unit = pd.to_numeric(export_core_summary.loc[mask, "\u4e3b\u4ea7\u54c1\u4ea7\u503c(\u5143/kg)"], errors="coerce").iloc[0]
                    total_unit = (float(main_unit) + float(side_unit)) if (pd.notna(main_unit) and pd.notna(side_unit)) else np.nan
